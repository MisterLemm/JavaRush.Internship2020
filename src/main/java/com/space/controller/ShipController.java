...
public class ShipController {
    ...
    public List<Ship> getShipList(@RequestParam(required = false) String name,
        ...
        List<Ship> filteredShips = shipService.getListOfShips(name, planet, shipType, after, before, isUsed, minSpeed,
    ...
    public int getShipCount(@RequestParam(required = false) String name,
                            ...
                            @RequestParam(required = false) Double minRating,
                            @RequestParam(required = false) Double maxRating) {
        return shipService.getListOfShips(name, planet, shipType, after, before, isUsed, minSpeed, maxSpeed, minCrewSize,
